...
# ====== Старые пользователи ======
OLD_USERS = [411024223, 965001148, 1054339680, 1170672864, 142446513, 143515040, 144448510, 152222817, 1809572389, 1845548278, 219915257, 287016970, 302385754, 330485093, 340903017, 359948286, 403348432, 430642799, 457647362, 458432038, 474911726, 512134196, 519535670, 5423547816, 5772217045, 6114789882, 6118094923, 6263267353, 6432740505, 665195417, 667061375, 6902524977, 711108520, 761625513, 886772711, 918296939, 923790419, 953565625]
...
SEND_HOURS = [12]  # часы по Москве для ежедневной рассылки
...
async def what_do_callback(callback: types.CallbackQuery):
    ...
    await callback.message.answer(
        ...
        "💫 Также ты можешь анонимно отправить ответ в общий канал t.me/ask_yourself_archive. "
